...
export const LoadingMessage = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-secondary p-4" dir={isRTL ? 'rtl' : 'ltr'}>
            <img
                ref={gifRef}
                src="/Robot.gif"
                alt="Loading bot"
            ...
            <span
                ref={textRef}
                className={`inline-block text-center text-foreground min-h-[48px] transition-opacity duration-150 ease-in-out will-change-opacity ${fade ? 'opacity-100' : 'opacity-0'}`}
                style={{
