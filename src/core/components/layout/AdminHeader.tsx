  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 h-16">
      <div className="flex h-full">
        ...
        <div className="w-64 bg-muted/50 border-r border-b border-border flex items-center px-6">
        ...
        <div className="flex-1 bg-background border-b border-border flex items-center justify-end px-6">
