  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      <StatCard
        ...
        value={stats.total}
        subtitle={t("users.stats.totalSubtitle")}
        icon={Users}
        iconBgColor="bg-purple-100"
        iconColor="text-purple-600"
      />
      <StatCard
        title={t("users.stats.verified")}
        value={stats.verified}
        subtitle={t("users.stats.verifiedSubtitle")}
        icon={CheckCircle}
        iconBgColor="bg-green-100"
        iconColor="text-green-600"
      />
      <StatCard
        title={t("users.stats.unverified")}
      ...
      <StatCard
        ...
        subtitle={t("users.stats.emailVerifiedSubtitle")}
        icon={Shield}
